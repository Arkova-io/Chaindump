...
SELECT
  ...
  json_extract(value, '$.lifecycle'),
  json_extract(value, '$.slug'),
  json_extract(value, '$.forensic_analysis'),
  json_extract(value, '$.sources'),
  json_extract(value, '$.replace_profile'),
  json_extract(value, '$.row_patch')
FROM forensic_payload, json_each(forensic_payload.document, '$.cases');
