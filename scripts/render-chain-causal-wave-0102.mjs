...
import { buildWaveKSpecs } from './chain-causal-wave-k-specs.mjs';

const root = resolve(dirname(fileURLToPath(import.meta.url)), '..');
const artifactPath = resolve(root, 'docs/chain-causal-completion-wave-k-2026-08-03.json');
const migrationPath = resolve(root, 'migrations/0102_chain_causal_completion_wave_k.sql');
const AS_OF = '2026-08-03';
const OBSERVED_AT = '2026-08-03T22:07:20.041Z';
const ACCESSED_AT = '2026-08-03T22:07:28.117Z';
const NEXT_REVIEW_AT = '2026-08-10T22:07:28.117Z';
...
const specs = buildWaveKSpecs({ source, claim, section, metric, event, marketSources, AS_OF, OBSERVED_AT, ACCESSED_AT });
...
const document = {
  ...
  methodology: {
    scope: 'Canonical ten-section blockchain profiles for Monad, OP Mainnet, Sui, Near and Mantle.',
    ...
    preservation_rule: 'Migration 0102 preserves legacy facts and analysis fields while adding forensic analysis, review metadata and an embedded canonical profile. Sources merge by URL.',
  },
  cases,
};
...
function renderMigration(value = document) {
  ...
  return `-- Generated by scripts/render-chain-causal-wave-0102.mjs.
-- Adds Wave K review-state canonical profiles without overwriting legacy dossiers.
