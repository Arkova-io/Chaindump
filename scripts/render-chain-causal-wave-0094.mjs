...
import { buildWaveISpecs } from './chain-causal-wave-i-specs.mjs';

const root = resolve(dirname(fileURLToPath(import.meta.url)), '..');
const artifactPath = resolve(root, 'docs/chain-causal-completion-wave-i-2026-08-03.json');
const migrationPath = resolve(root, 'migrations/0094_chain_causal_completion_wave_i.sql');
const AS_OF = '2026-08-03';
const OBSERVED_AT = '2026-08-03T20:23:49.000Z';
const ACCESSED_AT = '2026-08-03T20:23:55.000Z';
const NEXT_REVIEW_AT = '2026-08-10T20:23:55.000Z';
...
const specs = buildWaveISpecs({ source, claim, section, metric, event, marketSources, AS_OF, OBSERVED_AT, ACCESSED_AT });
...
const document = {
  ...
  methodology: {
    scope: 'Canonical ten-section blockchain profiles for Ethereum, Solana, BNB Smart Chain, Base and Hyperliquid L1.',
    ...
    preservation_rule: 'Migration 0094 preserves legacy facts and analysis fields while adding forensic analysis, review metadata and an embedded canonical profile. Sources merge by URL.',
  },
  cases,
};
...
function renderMigration(value = document) {
  ...
  return `-- Generated by scripts/render-chain-causal-wave-0094.mjs.
-- Adds Wave I review-state canonical profiles without overwriting legacy dossiers.
