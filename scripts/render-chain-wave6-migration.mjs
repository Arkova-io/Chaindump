...
const source = new URL('../docs/top50-chain-dossiers-wave6-2026-07-29.json', import.meta.url);
const destination = new URL('../migrations/0047_chain_dossiers_wave6.sql', import.meta.url);
const dossiers = JSON.parse(readFileSync(source, 'utf8'));
const payload = JSON.stringify(dossiers).replaceAll("'", "''");

const sql = `-- Generated by scripts/render-chain-wave6-migration.mjs from the cited wave-six dossier corpus.
