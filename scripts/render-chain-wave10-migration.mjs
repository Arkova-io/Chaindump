...
const source = new URL('../docs/top50-chain-dossiers-wave10-2026-07-29.json', import.meta.url);
const destination = new URL('../migrations/0051_chain_dossiers_wave10.sql', import.meta.url);
const dossiers = JSON.parse(readFileSync(source, 'utf8'));
const payload = JSON.stringify(dossiers).replaceAll("'", "''");

const sql = `-- Generated by scripts/render-chain-wave10-migration.mjs from the cited wave-ten dossier corpus.
