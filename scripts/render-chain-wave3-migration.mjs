...
const source = new URL('../docs/top50-chain-dossiers-wave3-2026-07-29.json', import.meta.url);
const destination = new URL('../migrations/0031_chain_dossiers_wave3.sql', import.meta.url);
const dossiers = JSON.parse(readFileSync(source, 'utf8'));
const payload = JSON.stringify(dossiers).replaceAll("'", "''");

const sql = `-- Generated by scripts/render-chain-wave3-migration.mjs from the cited wave-three dossier corpus.
