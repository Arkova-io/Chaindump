...
- 2026-07-30 reader-first intelligence pass: PR #99 adds a plain-language guide to the shared trend taxonomy and SLM schema. Every vertical now has a short human question (for example, “Does this exchange attract real traders and keep them when incentives fade?”), plus a canonical five-part reading order: what it is, what happened, why it turned out this way, what would change the call, and what to watch next. This is additive metadata for the UI/research agent; it does not turn tags into conclusions or relax citation/publication gates. Focused taxonomy tests and lint pass.
